...
$(function() {
    ...
    $('.devices li a').click(function(e) {
        ...
        $('#composition-pick').val($(this).attr('href'));
    ...
    $('#download').click(function(e) {
        ...
        $('.generated .generated__item img').each(function(index, item) {
            var imageSrc = $(item).attr('src');
            var imageData = imageSrc.replace('data:image/png;base64,', '');
            console.log(imageData);
            zip.file(index + '.png', imageData, { base64: true });
        });
